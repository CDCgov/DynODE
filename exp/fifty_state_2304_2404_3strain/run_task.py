...
sys.path.append("/app/")
sys.path.append("/input/exp/fifty_state_2304_2404_3strain/")
# sys.path.append(".")
...
class EpochTwoRunner(AbstractAzureRunner):
    # __init__ already implemented by the abstract case
    def __init__(self, azure_output_dir, jobid):
        self.jobid = jobid
    ...
    def process_state(self, state):
        ...
        state_config_path = (
            "/input/exp/fifty_state_2304_2404_3strain/%s/states/%s/"
            % (self.jobid, state)
        )
...
if __name__ == "__main__":
    ...
    runner = EpochTwoRunner(save_path, jobid)
