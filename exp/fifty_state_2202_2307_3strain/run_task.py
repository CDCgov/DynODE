...
sys.path.append("/app/")
sys.path.append("/input/exp/fifty_state_2202_2307_3strain/")
# sys.path.append(".")
...
class EpochOneRunner(AbstractAzureRunner):
    ...
    def process_state(self, state):
        model_day = 416
        # step 1: define your paths, now in the input folder
        state_config_path = (
            "/input/exp/fifty_state_2202_2307_3strain/states/" + state + "/"
        )
...
if __name__ == "__main__":
    ...
    # stdout = sys.stdout
    # stderror = sys.stderr
    save_path = "/output/fifty_state_2202_2307_3strain/%s/%s/" % (jobid, state)
