...
pytestmark = pytest.mark.parametrize(
    "inputs, expected_init_prop_shape, expected_cm_shape, expected_cm",
    [
        (
            {
                "age_demographics": jnp.array([1.0]),
                "risk_prop": jnp.array([[1.0]]),
                "s0_prop": jnp.array([[0.99]]),
                "i0_prop": jnp.array([[0.01]]),
        ...
        (
            {
                ...
                "s0_prop": jnp.array([[0.99], [0.99], [1.0]]),
                "i0_prop": jnp.array([[0.01], [0.01], [0.0]]),
