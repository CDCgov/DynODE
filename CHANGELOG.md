...
- Updated `numpy` version in `pyproject.toml` to >= 2.1, which is essential for python upgrades
- Removed upper limit for a bunch of dependencies as they are not impacting the package usage
