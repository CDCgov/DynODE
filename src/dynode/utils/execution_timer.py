...
def execution_timer(_func=None):
    ...
    def execution_timer_info(func):
        ...
        @wraps(func)
        def execution_timer_wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.info(" - End function", extra=extra_args)
        ...
        return execution_timer_wrapper

    if _func is None:
        return execution_timer_info
    else:
        return execution_timer_info(_func)
